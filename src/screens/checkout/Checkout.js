...
xhrAddresses.setRequestHeader("authorization", "Bearer " + sessionStorage.getItem("access-token"));
...
try{
  ...
  this.setState({totalCartItemsValue:this.props.location.state.totalCartItemsValue});
  this.setState({resDetails:this.props.location.state.restaurantDetails});
...
if(this.state.chcartItems === null || this.state.selAddress === null || this.state.paymentMethod === null){
  this.setState({saveOrderResponse : "Unable to place your order! Please try again!"})        
    ...
    <div>
      ...
      <Grid container spacing={1}>
        ...
        <Card >        
            ...
            <div style={{marginLeft:"3%",fontSize:"200%", color:"grey",fontWeight:"bold"}}>{this.state.resDetails.name}</div>
            <CardContent>
            <Grid
                container
                direction="row"
        ...
        return(
               ...
               <i className="fa fa-inr"></i><span>  {item.price}</span>                        
                 ...
                 <br/>
                    ...
                    <Grid container item xs={12} >
                        ...
                        <i style={{color:"grey"}}className="fa fa-inr"></i><span>  {this.props.location.state.totalCartItemsValue}</span>
                        </Typography>
                        </Grid>
                    </Grid>
                </Grid>                
            ...
            <CardActions >
                <Button style={{marginLeft:"7%"}} variant="contained" color="primary" className={this.props.classes.orderButton} onClick={this.placeOrderHandler}>
                    Place Order
                </Button>
            </CardActions>
        </Card>
